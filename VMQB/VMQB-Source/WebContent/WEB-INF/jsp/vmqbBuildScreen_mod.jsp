            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> VMetrix QueryBuilder&reg; Builder Screen
                        		...
                        		<table id="tablesDetails" border="0" width="100%">
									<tr>
										<td colspan="3">
											<div class="form-group">
													<label class="control-label col-md-3">Tables</label>
														<div class="col-md-4">
															<select  id="tableField" onchange="selectTable(this.value)" class="bs-select form-control" data-live-search="true" data-size="8">
									...
									<tr>
										<td colspan="3">
											<div class="form-group">
												...
												<div class="col-md-4">
													<!-- <button id="addBtn" onclick="addFields()">Add Field</button> -->
													<br>
													<select id="fieldsField" multiple  style="width: 100%"></select>
													<a href="javascript:addFields();" class="btn dark">
                                                            <i class="fa fa-check"></i> Add Fields</a>
												</div>
											</div>	
										</td>
									</tr>
									...
									<tr>
										<td colspan="3" align="center">
											<br><br> 
											<!-- <button id="generate" onclick="generateQuery()">Generate Query</button> -->
									...
									<tr>
										<td colspan="3" align="center">
											<br><br> 
											<!-- <button id="generateResults" onclick="generateResults()">Generate Results</button> -->
											<a href="javascript:generateResults();" class="btn dark">
                                                            <i class="fa fa-check"></i> Generate Results</a>
